...
public interface IStudentRepository
{
    ...
    Task<(List<Student> Items, int TotalCount, int PaidCount, int NotPaidCount, int ExemptedCount, int DiscountCount, decimal TotalCollected, decimal TotalDiscounted, Dictionary<Guid, (decimal PaidAmount, decimal DiscountAmount, string Status)> Payments)> GetPaymentReportAsync(
