...
namespace DiaconateSchool.Infrastructure.Migrations
{
    ...
    [Migration("20260822122509_RemoveAcademicYearDatesAddStudentBalance")]
    partial class RemoveAcademicYearDatesAddStudentBalance
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DiaconateSchool.Domain.Entities.Grade", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Level = 1,
                            Name = "KG1",
                            StageId = new Guid("00000000-0000-0000-0000-000000000001")
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            Level = 1,
                            Name = "جامعة",
                            StageId = new Guid("00000000-0000-0000-0004-000000000001")
                        },
                        new
                        {
                            ...
                            Level = 1,
                            Name = "خريجون",
                            StageId = new Guid("00000000-0000-0000-0005-000000000001")
                        },
                        new
                        {
                            ...
                            Level = 1,
                            Name = "كبار",
                            StageId = new Guid("00000000-0000-0000-0006-000000000001")
                        });
                });
